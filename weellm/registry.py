...
def _register_builtin_models() -> None:
    ...
    from .models.qwen_image import WeeQwenImagePipeline
    ...
    # Qwen-Image
    register_model("qwen-image", WeeQwenImagePipeline)
    register_model("qwen_image", WeeQwenImagePipeline) # underscore alias
